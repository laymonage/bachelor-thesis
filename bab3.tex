...
multiple paths as its arguments and there's a \verb|one_or_all| argument that
...
\verb|JSON_CONTAINS_PATH|, but the \verb|JSON_TYPE| with the \code{IS NOT
...
\verb|JSON_VALUE| function to extract scalar values and the \verb|JSON_QUERY|
