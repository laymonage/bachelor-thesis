...
\begin{itemize}
    ...
    \item Chapter 4 \babEmpat \\
        This chapter covers the implementation of \code{JSONField} and its
        extended querying capabilities.
    \item Chapter 5 \babLima \\
        This chapter covers the demonstration of validation rules applied on
        a \code{JSONField} to validate the JSON data inside the field.
    \item Chapter 6 \babEnam \\
        This chapter covers the tests for \code{JSONField} and the deprecation
