...
deserializes it), as shown by lines 2 to 6 of
\autoref{code:jsonfield-selectformat}. In the case of PostgreSQL, casting data
to \verb|TEXT| can be done using the \verb|::text| syntax, as shown by
\autoref{code:pgops}.
...
i.e. not \verb|None|) to the keyword arguments dictionary, as shown by lines 3
to 6 of \autoref{code:jsonfield-dec}.
